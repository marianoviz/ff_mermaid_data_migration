...
# Excel Output: 
#folder_path <- here("data", "processed", "indonesia", "ff2.0") #No NAs left --> Processed Folder 
#file_path <- file.path(folder_path, "ind_ff2.0_fish_processed.xlsx")
#write_xlsx(selected_ff2_fish_ind, file_path)
...
# Excel Output: 
#folder_path <- here("data", "preprocessed", "indonesia", "ff2.0") #NAs left --> Preprocessed Folder
#file_path <- file.path(folder_path, "ind_ff2.0_fish_preprocessed.xlsx")
#write_xlsx(selected_ff2_habitat_ind, file_path)
...
# Add the MA name to make it easier for the country teams to update the information
  # Fish
sites_ind_fish <- selected_ff2_fish_ind_sites%>%
...
# Excel Output: 
#folder_path <- here("data", "preprocessed", "indonesia", "ff2.0") #NAs left --> Preprocessed Folder
#file_path <- file.path(folder_path, "ind_ff2.0_fish_sites_preprocessed.xlsx")
...
# Habitat
sites_ind_habitat <- selected_ff2_habitat_ind_sites %>%
...
# Excel Output: 
#folder_path <- here("data", "preprocessed", "indonesia", "ff2.0") #NAs left --> Preprocessed Folder
#file_path <- file.path(folder_path, "ind_ff2.0_habitat_sites_preprocessed.xlsx")
